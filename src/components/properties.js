...
</div></div>) : (<section className="antialiased bg-gray-100 text-gray-600 px-4">
...
<button onClick={() => crawl(data.id,data.url)} disabled={(spin != false)} className="group relative py-[5px] px-3 overflow-hidden rounded-xl text-sm bg-green-500 text-white">
<div className="flex items-center justify-center">
{(spin === data.id) && <div role="status" className="inline-block">
